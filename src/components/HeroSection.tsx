      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Your AI Companion
            <br />
            <span className="text-gradient">Who Truly Understands</span>
          </motion.h1>
          ...
          >
            Connect with realistic AI avatars who listen, understand, and respond 
            with genuine emotion. Chat, call, and build meaningful connections.
          </motion.p>
          ...
          >
            <Button
              size="lg"
              className="gradient-primary glow-primary text-lg px-8 py-6 group"
              asChild
            >
              <Link to="/signup">
                Find Your SoulMate
